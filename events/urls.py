...
from events.views import home,create_event,CreateEvent,create_category,event_details,organizer,OrganizerView,delete_event,update_event,category_list,update_category,delete_category,rsvp,confirm_rsvp
urlpatterns = [
